...
class ApiModel extends (0, ApiItemContainerMixin_1.ApiItemContainerMixin)(ApiItem_1.ApiItem) {
    #resolver;
    #packagesByName = undefined;
    #apiItemsByCanonicalReference = undefined;
    constructor() {
        super({});
        this.#resolver = new ModelReferenceResolver_1.ModelReferenceResolver(this);
    }
    ...
    resolveDeclarationReference(declarationReference, contextApiItem) {
        if (declarationReference instanceof tsdoc_1.DocDeclarationReference) {
            ...
            if (!this.#apiItemsByCanonicalReference) {
                this.#apiItemsByCanonicalReference = new Map();
                for (const apiPackage of this.packages) {
            ...
            const apiItem = this.#apiItemsByCanonicalReference.get(declarationReference.toString());
            if (!apiItem) {
    ...
    #initApiItemsRecursive(apiItem, apiItemsByCanonicalReference) {
