...
class InternalScopedCommandLineParser extends CommandLineParser_1.CommandLineParser {
    ...
    constructor(options) {
        ...
        const toolCommandForLogging = `${toolFilename} ${aliasAction ?? actionOptions.actionName}`;
        const scopingArgs = [];
