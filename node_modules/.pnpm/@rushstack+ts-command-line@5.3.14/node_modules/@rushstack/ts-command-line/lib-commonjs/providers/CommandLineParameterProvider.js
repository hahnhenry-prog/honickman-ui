...
class CommandLineParameterProvider {
    ...
    #parametersByShortName;
    #parameterGroupsByName;
    #parametersHaveBeenRegistered;
    #parametersHaveBeenProcessed;
    #remainder;
    /** @internal */
    // Third party code should not inherit subclasses or call this constructor
    constructor() {
        this.#parameters = [];
        this.#parametersByLongName = new Map();
        this.#parametersByShortName = new Map();
        this.#parameterGroupsByName = new Map();
        this._ambiguousParameterParserKeysByName = new Map();
        this._registeredParameterParserKeysByName = new Map();
        this.#parametersHaveBeenRegistered = false;
        this.#parametersHaveBeenProcessed = false;
    }
    /**
    ...
    get parametersProcessed() {
        return this.#parametersHaveBeenProcessed;
    }
    /**
    ...
    getChoiceParameter(parameterLongName, parameterScope) {
        return this.#getParameter(parameterLongName, BaseClasses_1.CommandLineParameterKind.Choice, parameterScope);
    }
    /**
    ...
    getChoiceListParameter(parameterLongName, parameterScope) {
        return this.#getParameter(parameterLongName, BaseClasses_1.CommandLineParameterKind.ChoiceList, parameterScope);
    }
    /**
    ...
    getFlagParameter(parameterLongName, parameterScope) {
        return this.#getParameter(parameterLongName, BaseClasses_1.CommandLineParameterKind.Flag, parameterScope);
    }
    ...
    getIntegerParameter(parameterLongName, parameterScope) {
        return this.#getParameter(parameterLongName, BaseClasses_1.CommandLineParameterKind.Integer, parameterScope);
    }
    /**
    ...
    getIntegerListParameter(parameterLongName, parameterScope) {
        return this.#getParameter(parameterLongName, BaseClasses_1.CommandLineParameterKind.IntegerList, parameterScope);
    }
    ...
    getStringParameter(parameterLongName, parameterScope) {
        return this.#getParameter(parameterLongName, BaseClasses_1.CommandLineParameterKind.String, parameterScope);
    }
    /**
    ...
    defineCommandLineRemainder(definition) {
        ...
        this.#remainder = new CommandLineRemainder_1.CommandLineRemainder(definition);
        return this.#remainder;
    }
    /**
    ...
    getStringListParameter(parameterLongName, parameterScope) {
        return this.#getParameter(parameterLongName, BaseClasses_1.CommandLineParameterKind.StringList, parameterScope);
    }
    /**
    ...
    _registerDefinedParameters(state) {
        if (this.#parametersHaveBeenRegistered) {
        ...
        this.#parametersHaveBeenRegistered = true;
    }
    /**
    ...
    _processParsedData(parserOptions, data) {
        ...
        if (this.#parametersHaveBeenProcessed) {
        ...
        for (const [parameterName, parserKey] of this._ambiguousParameterParserKeysByName) {
            if (data[parserKey]) {
                ...
                const duplicateShortNameParameters = this.#parametersByShortName.get(parameterName);
                if (duplicateShortNameParameters) {
                    ...
                    for (const parameter of duplicateShortNameParameters) {
                        const matchingLongNameParameters = this.#parametersByLongName.get(parameter.longName);
                    ...
                    this.#throwParserExitError(parserOptions, data, 1, `Ambiguous option: "${parameterName}" could match ${nonAmbiguousLongNames.join(', ')}.`);
                }
                const duplicateLongNameParameters = this.#parametersByLongName.get(parameterName);
        ...
        this.#parametersHaveBeenProcessed = true;
    }
    /** @internal */
    _defineParameter(parameter) {
        ...
        let longNameParameters = this.#parametersByLongName.get(parameter.longName);
        ...
        if (parameter.shortName) {
            let shortNameParameters = this.#parametersByShortName.get(parameter.shortName);
    ...
    _registerParameter(parameter, useScopedLongName, ignoreShortName) {
        ...
        let argumentGroup;
        if (parameterGroup) {
            argumentGroup = this.#parameterGroupsByName.get(parameterGroup);
            if (!argumentGroup) {
                ...
                this.#parameterGroupsByName.set(parameterGroup, argumentGroup);
            }
        }
        else {
        ...
        if (required && environmentVariable) {
            ...
            const originalPreParse = parameter._preParse?.bind(parameter);
            parameter._preParse = () => {
                originalPreParse?.();
                // Set the value as non-required before parsing. We'll validate it explicitly
                argparseArgument.required = false;
            };
            const originalPostParse = parameter._postParse?.bind(parameter);
            parameter._postParse = () => {
            ...
            const originalValidateValue = parameter._validateValue?.bind(parameter);
    ...
    #getParameter(parameterLongName, expectedKind, parameterScope) {
        ...
        const parameters = this.#parametersByLongName.get(parameterLongName);
        if (!parameters) {
    ...
    #throwParserExitError(parserOptions, data, errorCode, message) {
