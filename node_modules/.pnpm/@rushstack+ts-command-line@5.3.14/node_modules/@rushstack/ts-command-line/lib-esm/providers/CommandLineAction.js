...
export class CommandLineAction extends CommandLineParameterProvider {
    ...
    _buildParser(actionsSubParser) {
        ...
        this.#argumentParser.exit = (status, message) => {
            throw new CommandLineParserExitError(status, message);
        };
        const originalArgumentParserErrorFn = this.#argumentParser.error.bind(this.#argumentParser);
        this.#argumentParser.error = (err) => {
