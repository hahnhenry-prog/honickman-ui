...
class StringBufferTerminalProvider {
    #standardBuffer = new node_core_library_1.StringBuilder();
    #verboseBuffer = new node_core_library_1.StringBuilder();
    #debugBuffer = new node_core_library_1.StringBuilder();
    #warningBuffer = new node_core_library_1.StringBuilder();
    #errorBuffer = new node_core_library_1.StringBuilder();
    #allOutputChunks = [];
    /**
    ...
    write(text, severity) {
        ...
        const lastChunk = this.#allOutputChunks[this.#allOutputChunks.length - 1];
