...
class StdioSummarizer extends TerminalWritable_1.TerminalWritable {
    ...
    getReport() {
        ...
        const report = [...this.#abridgedLeading];
    ...
    onWriteChunk(chunk) {
        ...
        if (chunk.kind === ITerminalChunk_1.TerminalChunkKind.Stderr && !this.#abridgedStderr) {
        ...
        else if (this.#abridgedStderr && chunk.kind !== ITerminalChunk_1.TerminalChunkKind.Stderr) {
