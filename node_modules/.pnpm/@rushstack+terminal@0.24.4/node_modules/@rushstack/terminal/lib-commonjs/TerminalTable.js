...
class TerminalTable {
    ...
    getLines() {
        ...
        const specifiedColWidths = this.#specifiedColWidths;
        const borderColor = this.#borderColor;
        const headingColor = this.#headingColor;
        const { top: topSeparator, topCenter: topCenterSeparator, topLeft: topLeftSeparator, topRight: topRightSeparator, bottom: bottomSeparator, bottomCenter: bottomCenterSeparator, bottomLeft: bottomLeftSeparator, bottomRight: bottomRightSeparator, left: leftSeparator, leftCenter: leftCenterSeparator, horizontalCenter: horizontalCenterSeparator, centerCenter: centerCenterSeparator, right: rightSeparator, rightCenter: rightCenterSeparator, verticalCenter: verticalCenterSeparator } = this.#borderCharacters;
