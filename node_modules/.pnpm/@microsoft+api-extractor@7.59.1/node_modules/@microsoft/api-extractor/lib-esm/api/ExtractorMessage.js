 ...
 * @public
 */
export var ExtractorMessageCategory;
...
})(ExtractorMessageCategory || (ExtractorMessageCategory = {}));
/**
...
export class ExtractorMessage {
    ...
    /** @internal */
    constructor(options) {
        const { category, messageId, text, sourceFilePath, sourceFileLine, sourceFileColumn, properties = {}, logLevel = ExtractorLogLevel.None } = options;
