...
import { JsonFile, JsonSchema, FileSystem, Objects, PackageJsonLookup, PackageName, InternalError, Path, NewlineKind } from '@rushstack/node-core-library';
...
const _defaultConfig = JsonFile.load(path.join(__dirname, '../schemas/api-extractor-defaults.json'));
/**
...
export class ExtractorConfig {
     ...
     */
    static jsonSchema = JsonSchema.fromLoadedObject(apiExtractorSchema);
    /**
    ...
    static loadFile(jsonFilePath) {
        ...
        configObject = Objects.mergeWith(structuredClone(_defaultConfig), configObject, mergeCustomizer);
    ...
    static prepare(options) {
        ...
        try {
            ...
            const enumMemberOrder = configObject.enumMemberOrder ?? EnumMemberOrder.ByName;
