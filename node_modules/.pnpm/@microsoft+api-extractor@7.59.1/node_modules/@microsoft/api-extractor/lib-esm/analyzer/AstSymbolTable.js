...
export class AstSymbolTable {
    ...
    #fetchAstDeclaration(node, isExternal) {
        ...
        const symbol = TypeScriptHelpers.getSymbolForDeclaration(node, this.#typeChecker);
        if (!symbol) {
            ...
            if (!nominalAnalysis) {
                ...
                if (arbitraryDeclaration) {
                    ...
                    if (arbitraryParentDeclaration) {
                        const parentSymbol = TypeScriptHelpers.getSymbolForDeclaration(arbitraryParentDeclaration, this.#typeChecker);
