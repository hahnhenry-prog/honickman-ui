    ...
    #getParentReference(symbol) {
        ...
        if (entity) {
            ...
            if (firstExportingConsumableParent &&
                ...
                const parentSymbol = TypeScriptInternals.tryGetSymbolForDeclaration(firstExportingConsumableParent.astEntity.declaration, this.#collector.typeChecker);
                if (parentSymbol) {
        ...
        if (grandParent && ts.isModuleDeclaration(grandParent)) {
            const grandParentSymbol = TypeScriptInternals.tryGetSymbolForDeclaration(grandParent, this.#collector.typeChecker);
