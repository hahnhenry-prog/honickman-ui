...
export class ApiModelGenerator {
    ...
    constructor(collector, extractorConfig) {
        ...
        this.#referenceGenerator = new DeclarationReferenceGenerator(collector);
    ...
    #processApiEnum(astDeclaration, context) {
        ...
        if (apiEnum === undefined) {
            ...
            const docComment = apiItemMetadata.tsdocComment;
            const releaseTag = apiItemMetadata.effectiveReleaseTag;
            const preserveMemberOrder = this.#collector.extractorConfig.enumMemberOrder === EnumMemberOrder.Preserve;
    ...
    #buildExcerptTokens(astDeclaration, nodeTransforms) {
        ...
        ExcerptBuilder.addDeclaration(excerptTokens, astDeclaration, nodeTransforms, this.#referenceGenerator);
        ...
        for (const ancillaryDeclaration of declarationMetadata.ancillaryDeclarations) {
            ...
            ExcerptBuilder.addDeclaration(excerptTokens, ancillaryDeclaration, nodeTransforms, this.#referenceGenerator);
        }
