...
class SpanModification {
     ...
     * expensive.
     */
    indentDocComment = IndentDocCommentScope.None;
    #span;
    #prefix;
    #suffix;
    constructor(span) {
...
class Span {
    ...
    #getSubstring(startIndex, endIndex) {
