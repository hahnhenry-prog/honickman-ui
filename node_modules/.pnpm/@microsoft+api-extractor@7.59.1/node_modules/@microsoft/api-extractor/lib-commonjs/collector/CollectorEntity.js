...
class CollectorEntity {
    ...
    astEntity;
    #exportNames = new Set();
    #exportNamesSorted = false;
    #singleExportName = undefined;
    #localExportNamesByParent = new Map();
    #nameForEmit = undefined;
    #sortKey = undefined;
    ...
    get exportNames() {
        if (!this.#exportNamesSorted) {
            node_core_library_1.Sort.sortSet(this.#exportNames);
    ...
    addLocalExportName(localExportName, parent) {
        const localExportNames = this.#localExportNamesByParent.get(parent) || new Set();
    ...
    getSortKey() {
        if (!this.#sortKey) {
            this.#sortKey = Collector_1.Collector.getSortKeyIgnoringUnderscore(this.nameForEmit || this.astEntity.localName);
        }
        return this.#sortKey;
    }
}
